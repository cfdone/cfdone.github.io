  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black">
                        ...
                        <div className="px-4 pb-4 border-t border-white/10">
                          <div className="pt-4 max-h-64 overflow-y-auto no-scrollbar">
                            <div className="text-white/70 text-sm  space-y-4">
                              <p>
                                By using CFDONE, you agree to these terms and conditions. This app
                                is designed specifically for FAST University students to manage
                                their timetables.
                              </p>
                              <p>
                                <strong className="text-white">Google Authentication:</strong> When
                                you sign in with Google, we only access your basic profile
                                information (name, email, profile picture) to provide authentication
                                services. We do not access your Google Drive, Gmail, or other Google
                                services.
                              </p>
                              <p>
                                <strong className="text-white">Usage:</strong> This app is provided
                                as-is for educational purposes. We are not responsible for any
                                scheduling conflicts or missed classes.
                              </p>
                              <p>
                                <strong className="text-white">Data:</strong> All timetable data is
                                stored locally on your device. We do not collect or store any
                                personal information on external servers beyond what's necessary for
                                authentication.
                              </p>
                              <p>
                                <strong className="text-white">Account Information:</strong> Your
                                Google account information is used solely for authentication and
                                personalization purposes. You can revoke access at any time through
                                your Google account settings.
                              </p>
                              <p>
                                <strong className="text-white">Updates:</strong> The app may receive
                                updates to improve functionality and fix bugs. Continued use implies
                                acceptance of updated terms.
                              </p>
                              <p>
                                <strong className="text-white">Contact:</strong> For any issues or
                                questions, please contact the developer through the provided
                                channels.
                              </p>
                            </div>
                          </div>
                      ...
                      {expandedAccordion === 'privacy' && (
                        <div className="px-4 pb-4 border-t border-white/10">
                          <div className="pt-4 max-h-64 overflow-y-auto no-scrollbar">
                            <div className="text-white/70 text-sm  space-y-4">
                              <p>
                                Your privacy is important to us. This policy explains how CFDONE
                                handles your information.
                              </p>
                              <p>
                                <strong className="text-white">Google Sign-In:</strong> When you use
                                Google Sign-In, we receive and store only your basic profile
                                information (name, email address, and profile picture). This
                                information is used for authentication and personalization purposes
                                only.
                              </p>
                              <p>
                                <strong className="text-white">Data Collection:</strong> Beyond
                                Google authentication data, we do not collect, store, or transmit
                                any additional personal data to external servers. All timetable
                                information remains on your device.
                              </p>
                              <p>
                                <strong className="text-white">Local Storage:</strong> Your
                                timetable preferences and settings are stored locally using your
                                browser's localStorage feature. This data never leaves your device.
                              </p>
                              <p>
                                <strong className="text-white">Google Data Usage:</strong> We do not
                                access your Google Drive, Gmail, calendar, or any other Google
                                services. We only use the minimal profile information necessary for
                                authentication.
                              </p>
                              <p>
                                <strong className="text-white">Third-Party Services:</strong> We use
                                Supabase for authentication services, which handles your Google
                                sign-in securely. No other third-party tracking or analytics
                                services are used.
                              </p>
                              <p>
                                <strong className="text-white">Data Retention:</strong> Your
                                authentication data is retained only as long as you maintain an
                                account. You can delete your account and all associated data at any
                                time.
                              </p>
                              <p>
                                <strong className="text-white">Data Security:</strong> All
                                authentication is handled through secure, encrypted connections.
                                Local data is under your full control and can be cleared anytime by
                                resetting the app.
                              </p>
                              <p>
                                <strong className="text-white">Your Rights:</strong> You can access,
                                modify, or delete your account information at any time. You can also
                                revoke app access through your Google account settings.
                              </p>
                              <p>
                                <strong className="text-white">Changes:</strong> Any changes to this
                                privacy policy will be reflected in app updates and communicated to
                                users.
                              </p>
                            </div>
                          </div>
        ...
        {/* Clear Cache Confirmation Modal removed */}
