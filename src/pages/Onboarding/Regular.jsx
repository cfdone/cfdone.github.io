    ...
    <div className="h-screen bg-black flex flex-col items-center px-2 pt-safe-offset-8 pb-safe-offset-3">
      ...
      <div className="h-full flex flex-col justify-between items-center w-full">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-2xl">
                          <GraduationCap
                            className={`w-8 h-8 ${selectedDegree === deg ? 'text-white' : 'text-accent'}`}
                          />
                        </div>
                      </div>
                    </button>
                    ...
                    {semesterNames.map(sem => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-2xl">
                            <Calendar
                              className={`w-8 h-8 ${selectedSemester === sem ? 'text-white' : 'text-accent'}`}
                            />
                          </div>
                        </div>
                      </button>
                    ...
                    {sectionNames.map(sec => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <Tag
                            className={`w-6 h-6 ${selectedSection === sec ? 'text-white' : 'text-accent'}`}
                          />
                        </div>
                      </button>
                    ))}
        ...
        <div className="flex flex-row gap-3 items-stretch justify-center w-full max-w-md mx-auto px-2 pb-6 pt-2 bg-gradient-to-b from-transparent to-black h-20">
          <button
            className=" px-4 rounded-3xl w-full h-full text-[15px] transition shadow-md bg-white/10 border text-white border-accent/5 hover:bg-accent/10 flex items-center justify-center"
