                ...
                <>
                  ...
                  >
                    ...
                    <div className="mt-2 text-xs text-yellow-300 font-semibold">
                      Please reverify your timetable and class times for each day before proceeding.<br />
                    ...
                    {geminiSuggestions && !isReverifying && (
                      <div className="mt-2">
                        ...
                        >
                          ...
                          {(() => {
                            const html = geminiSuggestions.replace(/```html[\s\S]*?<div/gi, '<div').replace(/```/g, '').trim();
                            // Try to split reasoning and review card if Gemini outputs two divs
                            const parts = html.split(/(<div[^>]*class=["']?[^"'>]*review-card[^"'>]*["']?[^>]*>)/i);
                            if (parts.length > 1) {
                              return (
                                <>
