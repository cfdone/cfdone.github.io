...
export async function verifyTimetableWithGemini({ timetable, conflictSubjects, resolutionSuggestions, selectedSubjects }) {
	const apiKey = 'AIzaSyBO15DH_S07iR84LUqfp-fS9DZRuIJ-SnA';
